...
dst_mdl=exp/evaluation/mono_vow5_tau${tau}_ubm_ali/${model_name}
spk_mdl=exp/mono_vow5_ali_tr_MAPadapt_tau${tau}/${model_name}

trl_lst=/data07/maulik/corpus/SdSV/docs/trials.txt
raw_spk=scores/raw/spk/mono_vow5_tau${tau}
raw_ubm=scores/raw/mono_vow5_tau${tau}_ubm_ali
scr_pth=scores/mono_vow5_tau${tau}
